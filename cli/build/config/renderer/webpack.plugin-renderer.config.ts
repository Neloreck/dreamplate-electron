...
import {
  ...
  IS_PRODUCTION,
  MODULES_CONFIG,
  REPORT_RENDERER_ANALYZER_PATH,
  REPORT_RENDERER_STATS_PATH,
  RUNTIME_CONSTANTS,
  TS_CONFIG_PATH,
...
export const PLUGIN_CONFIG: Configuration["plugins"] = [
   ...
   * Maintain separate submodule with own base template for each renderer.
   */
    ...
    IS_ANALYZE_ENABLED
      ? [
        new BundleAnalyzerPlugin({
          ...
          defaultSizes: "gzip",
          openAnalyzer: false,
          reportFilename: REPORT_RENDERER_ANALYZER_PATH
        }),
        new StatsWriterPlugin({
          filename: REPORT_RENDERER_STATS_PATH,
          stats: {
            all: true,
            assets: true,
