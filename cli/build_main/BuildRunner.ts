...
import { PROJECT_OUTPUT_FILE_PATH, PROJECT_ROOT_PATH, WEBPACK_CONFIG } from "./config";
...
export class BuildRunner {
  ...
  public static main(): void {
    ...
    process.stdout.write(
      `Started building PROCESS bundle in ${green(process.env.NODE_ENV || "unselected")} mode. \n` +
      `Project root: '${green(PROJECT_ROOT_PATH)}', project output: '${green(PROJECT_OUTPUT_FILE_PATH)}'. \n\n`
    );
