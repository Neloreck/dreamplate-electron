...
export function createDefaultTheme(themeType: TThemeType): IApplicationTheme {
  return {
    palette: {
      background: {
        default:
          themeType === "dark" ? GTheme.DEFAULT_BACKGROUND_DARK : GTheme.DEFAULT_BACKGROUND_LIGHT,
        paper:
          themeType === "dark"
            ? GTheme.DEFAULT_BACKGROUND_PAPER_DARK
            : GTheme.DEFAULT_BACKGROUND_PAPER_LIGHT
      },
      primary: {
      ...
      text: {
        primary:
          themeType === "dark"
            ? GTheme.DEFAULT_TEXT_PRIMARY_DARK
            : GTheme.DEFAULT_TEXT_PRIMARY_LIGHT,
        secondary:
          themeType === "dark"
            ? GTheme.DEFAULT_TEXT_SECONDARY_DARK
            : GTheme.DEFAULT_TEXT_SECONDARY_LIGHT
      },
      type: themeType
    },
    spacing: {
...
export function toggleTheme(
  { palette, spacing }: IApplicationTheme,
  requestedType?: TThemeType
): IApplicationTheme {
